...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`HG DEPO YÖNETİMİ`}</title>

        <meta
          name="description"
          content="Welcome to HG DEPO YÖNETİMİ - Your ultimate solution for stock, location tracking, goods receipt, and shipment management. Streamlining your business operations one step at a time."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1616401784845-180882ba9ba8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxpbnZlbnRvcnl8ZW58MHx8fHwxNjk1MzY2NTgyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HG DEPO YÖNETİMİ - Your ultimate solution for stock, location tracking, goods receipt, and shipment management. Streamlining your business operations one step at a time.`}
            </Text>
            <Box
